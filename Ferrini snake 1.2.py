...
def movimiento():
    ...
    if posicion_food == posicion_snake[0]:
        ...
        canvas.create_text(*posicion_snake[-1], text= '🧑', fill='aqua', 
...
canvas.create_text(75,75, text='🍕', fill='yellow',
 font = ('Arial',18), tag = 'food')

button1 = Button(frame_1, text='Salir', bg='red2' ,
    command = salir)
button1.grid(row=0, column=0, padx=20)

button2 = Button(frame_1, text='Iniciar', bg='green', 
    command = movimiento)
